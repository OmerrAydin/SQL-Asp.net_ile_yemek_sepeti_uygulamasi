...
C# , SQL, ASP.NET, HTML, CSS

Proje Nasıl çalıştırılmalı:
Öncelikle .bak formatlı veriTabanımızı sqle ekliyoruz. Proje zipten çıkarılmalıdır. Sonrasında Kodlar klasörü - yemek sepetinin içindeki kodlar projemize eklenmeli ve çalıştırılmalıdır.
